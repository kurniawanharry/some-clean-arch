...
class SignEmployeeUseCase extends UseCase<EmployeeModel, EmployeeModel> {
  final AbstractAuthRepository repository;

  SignEmployeeUseCase(this.repository);

  @override
  Future<Either<Failure, EmployeeModel>> call(params) async {
    final result = await repository.signEmployee(params);
