...
import 'package:some_app/src/core/styles/app_font_size.dart';
...
class AppTextStyle {
  ...
  static const mediumBlack = TextStyle(
      fontSize: AppFontSize.medium, color: AppColors.black, fontWeight: FontWeight.normal);
  ...
  static const mediumWhite = TextStyle(
      fontSize: AppFontSize.medium, color: AppColors.white, fontWeight: FontWeight.normal);
